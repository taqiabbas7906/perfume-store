...
export default function ProductDetailPage() {
  ...
  // Check if current variant has a discount
  const hasDiscount = variant && variant.discountedPrice && variant.discountedPrice < variant.originalPrice
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              {product.variants.map((v) => {
                const variantHasDiscount = v.discountedPrice && v.discountedPrice < v.originalPrice
                const variantDiscountPercentage = variantHasDiscount 
                  ? Math.round(((v.originalPrice - v.discountedPrice!) / v.originalPrice) * 100)
                  : 0
                const variantPrice = v.discountedPrice ?? v.originalPrice
                ...
                return (
                  <button
                    ...
                    className={`px-4 py-2 border rounded-lg text-left min-w-[120px] ${
